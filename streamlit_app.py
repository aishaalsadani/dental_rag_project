...
/* ---- SOURCES EXPANDER (force readable colors) ---- */
...
/* ---- NEW CHAT small link-style button ---- */
...
/* ---- CHAT INPUT BAR (force white, remove black) ---- */
...
# ---------------------------------------------------------------------------
    ...
    # Small "New chat" button (link-style, top-right of chat area)
